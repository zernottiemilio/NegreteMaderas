document.addEventListener("DOMContentLoaded", function () {
  ...
  // MEJORADO: Función para alternar visibilidad de contraseña
  const setupPasswordToggle = () => {
    ...
    // Crear iconos SVG como alternativa a Bootstrap Icons
    const eyeIcon = `
    ...
    togglePassword.addEventListener("click", function (e) {
      ...
      togglePassword.innerHTML = type === "password" ? eyeSlashIcon : eyeIcon;

      // Alternar clases para estilos adicionales si es necesario
      togglePassword.classList.toggle("show-password");
    });
  };

  // Llamar a la función de configuración del toggle de contraseña
  setupPasswordToggle();
